...
function Logo() {
  ...
  const fillColor = isDark ? '#ffffff' : '#338bff'
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
        <div className={`flex items-center justify-between h-16 mt-4 px-6 rounded-2xl backdrop-blur-xl border transition-colors duration-500 ${
          isDark
            ? 'bg-dcde-surface-dark/60 border-dcde-border'
            : 'bg-white/60 border-dcde-border-dark'
        }`}>
          <Logo />
