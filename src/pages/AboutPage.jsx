  ...
  return (
    <div className="min-h-[100dvh]">
      ...
      <div className="max-w-[1440px] mx-auto" style={{ padding: '0 var(--spacing-page-margin)' }}>
        <Link
          to="/"
          className="dcde-link dcde-text-xs text-grey-text hover:text-text inline-flex items-center gap-2 mb-12"
        >
        ...
        <div className="max-w-3xl">
          <h1 className="dcde-text-lg dcde-text-accent tracking-tight mb-8">
            关于
          </h1>

          <div className="space-y-6 dcde-text-sm text-grey-text">
            <p>
              DCDE·make 是一个面向视觉设计师的工具合集网站。我们相信，好的工具应该像好的设计一样——
              <span className="text-accent">精确、直觉、没有多余的噪音</span>。
            </p>
            <p>
          ...
          <div className="mt-16 pt-8 border-b-2 border-border">
            <h2 className="dcde-text-sm dcde-text-accent mb-6">
              设计理念
            </h2>
            <ul className="space-y-4 dcde-text-sm text-grey-text">
